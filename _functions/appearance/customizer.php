...
function nwd_theme_customize_register( $wp_customize ) {
    ...
    /****** FOOTER OPTIONS (START) ******/
        ...
        $wp_customize->add_section('footer', array('title' => 'Footer', 'description' => '', 'priority' => 8, ));
...
function nwd_theme_customize_preview_js() {
    wp_enqueue_script( 'nwd_theme_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}

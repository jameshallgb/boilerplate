...
function theme_base_styles()    {
    ...
    echo '<style>';
        ...
        if ( !empty( $top_bar_bg_colour ) ) {
            ...
            echo '.top-bar { 
                background-color:'.$top_bar_bg_colour.'
                }'
        ...
        if ( ( $header_transparent==1 || $header_transparent_page==1 )) { 
            ...
            echo 'header#masthead { 
                ...
                header#masthead.header-mobile-nav-open {
                    background-color: black;
                }'
            ;}
        
        // Menu
        if ( !empty( $menu_colour ) || !empty ( $menu_line_height ) || !empty ( $menu_text_size )  ) { 
        ...
        if ( !empty( $menu_hover_colour )  ) { 
            ...
            echo 'body #masthead .navbar-nav > li:hover > a,  body #masthead .navbar-nav .dropdown-menu li:hover .dropdown-item {
        ...
        if ( !empty( $menu_active_colour )  ) { 
            ...
            echo 'body #masthead .navbar-nav > li.current_page_item > a, body #masthead .navbar-nav .dropdown-menu li .dropdown-item {
                    color:'.$menu_active_colour.'
            }'
        ...
        if ( !empty( $copyright_bg_colour ) ) {
            ...
            echo 'body footer#colophon.site-footer {
                    background-color:'.$copyright_bg_colour.';
            }'
